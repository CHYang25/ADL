...
def main():
    ...
    def prepare_train_features(examples):
        ...
        # For bonus, to merge the multiple choice model and the extractive model, just concat all the paragraphs of the choices into a long paragraph
        # Then, deploy the extractive model to fetch the correct answer span.
        # This segment of code is to concatenate the paragraphs
        context_list = []
        for para in examples[context_column_name]:
            concat = ""
            for i in para:
                concat += context[i]
            context_list.append(concat)
    ...
    def prepare_validation_features(examples):
        ...
        # concatenate the four paragraphs
        context_list = []
        for para in examples[context_column_name]:
            concat = ""
            for i in para:
