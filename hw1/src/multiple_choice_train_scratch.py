...
def main():
    ...
    if args.tokenizer_name:
        tokenizer = AutoTokenizer.from_pretrained(
            args.tokenizer_name, use_fast=not args.use_slow_tokenizer, trust_remote_code=args.trust_remote_code, cache_dir=args.output_dir
        )
    elif args.model_name_or_path:
        tokenizer = AutoTokenizer.from_pretrained(
            args.model_name_or_path, use_fast=not args.use_slow_tokenizer, trust_remote_code=args.trust_remote_code, cache_dir=args.output_dir
        )
    else:
        raise ValueError(
    ...
    # Load model from config can load the model structure, but not the weights
    ...
    def preprocess_function(examples):
        ...
        labels = [options.index(label) for label, options in zip(examples[label_name], examples[context_name])] # the answer
